!pip install pyTelegramBotAPI #Вставляем перед запуском 
!pip install Faker #Вставляем перед запуском 
from telebot import TeleBot, types
from faker import Faker


bot = TeleBot(token='6859644519:AAF4bJj74LlgnyyvAKCtB56Cysbxv1pImhQ', parse_mode='html')
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет! Я не умею генерировать номер тестовой банковской карты, но ради тебя попробую!\nВыбери тип карты:', # текст сообщения
